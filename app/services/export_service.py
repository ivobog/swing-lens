...
COMBINED_HEADERS = [
    ...
    "technical_setup_quality_score",
    "technical_entry_quality_score",
    "technical_composite_score",
    "technical_confidence_adjusted_score",
...
def _combined_row(
    ...
    return {
        ...
        **technical_v4,
        ...
        "upcoming_earnings_date": result.upcoming_earnings_date,
        "days_until_earnings": result.days_until_earnings,
        "earnings_risk_level": result.earnings_risk_level,
        "earnings_warning_flags": _warning_flags_text(result.earnings_warning_flags_json),

...
def provider_storage_projection(
    ...
    allowed = {
        ...
        "surprise_percent", "event_kind", "acquisition_policy",
        "provider_consensus_semantics", "category", "subtype", "title", "headline",
        "subject", "canonical_text", "confidence", "status", "direction",
        "materiality", "tags", "related_tickers", "sentiment", "expected_date",
        "issuer_relevance", "issuer_relevance_reason", "binary_eligible",
        "source_reference",

...
class ProbabilityEstimator:
    ...
    def _select_cohort(
        ...
        *,
        ...
        for level_config, cohort_key in zip(config.cohort.hierarchy, keys, strict=True):
    ...
    def _persist_insufficient(
        ...
        *,
        ...
        evidence = (
            self.evidence_service.load_evidence(
                db,
                prediction=prediction,
                outcome_definition=outcome_definition,
        ...
        estimate = WinnerProbabilityEstimate(
            ...
            metadata_json=_estimate_metadata(
                ...
                config=config,
                reconstruction_method=reconstruction_method,
                extra={"cold_start_raw_counts_visible": True},
            ),
        )
        db.add(estimate)
        db.flush()

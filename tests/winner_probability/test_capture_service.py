...
from app.models.tables import EntryDataStatus, PredictionEligibility
...
def test_completed_run_creates_snapshot_pending_outcomes_and_decision_estimate() -> None:
    ...
    assert repository.estimates[0].insufficient_reasons_json == [
        "phase_6_estimator_not_implemented"
    ]
